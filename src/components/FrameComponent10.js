...
const FrameComponent10 = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-col items-start justify-start max-w-full text-center text-31xl text-gainsboro font-poppins ${className}`}
    >
      <Navigation1
        logo2="/logo-2@2x.png"
        ...
        navigationPadding="24px 53px 22px 60px"
        pageLinksPadding="11px 0px 0px"
        buttonWrapperPadding="11px 0px 0px"
      />
      <div className="self-stretch bg-gray-300 flex flex-row items-start justify-start pt-0 px-0 pb-px box-border gap-[79px] max-w-full z-[1] mt-[-4px] gap-[39px] gap-5 mq1275:flex-wrap">
