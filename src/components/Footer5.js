...
const Footer5 = ({ className = "", propAlignSelf, propHeight }) => {
  ...
  return (
    <footer
      className={`self-stretch bg-gray-300 flex flex-row items-end justify-center pt-[123px] px-[51px] pb-[139px] box-border [row-gap:20px] max-w-full text-left text-45xl text-silver font-lato lg:flex-wrap mq750:pt-20 mq750:px-[25px] mq750:pb-[90px] mq750:box-border ${className}`}
    >
      ...
      <div className="flex-1 flex flex-row items-start justify-center min-w-[617px] [row-gap:20px] max-w-full mq750:min-w-full mq1050:flex-wrap">
        <div className="flex-1 flex flex-col items-start justify-start gap-[46px] min-w-[358px] max-w-full gap-[23px] mq750:min-w-full">
          <div className="self-stretch flex flex-col items-start justify-start max-w-full">
            <h1 className="m-0 self-stretch h-[107px] relative text-inherit tracking-[-0.25px] leading-[64px] font-extrabold font-inherit flex items-center shrink-0 [text-shadow:0px_4px_4px_rgba(0,_0,_0,_0.25)] z-[1] mq1050:text-32xl mq1050:leading-[51px] mq450:text-19xl mq450:leading-[38px]">
              Connect
            </h1>
