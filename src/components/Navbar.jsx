...
const Navbar = () => {
  return (
    <section
      className={`self-stretch flex flex-col items-end justify-start pt-0 px-0 pb-[319.4px] box-border relative gap-[71px] max-w-full text-left text-46xl text-gray-300 font-lato gap-[18px] gap-[35px] mq750:pb-52 mq750:box-border`}
    >
      <Navigation1
