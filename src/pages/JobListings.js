...
const JobListings = () => {
  return (
    <div className="w-full h-[1694px] relative bg-gray-300 overflow-hidden flex flex-col items-end justify-start pt-0 px-0 pb-[122px] box-border gap-[86px] leading-[normal] tracking-[normal] text-center text-6xl text-silver font-lato gap-[21px] gap-[43px] mq1275:h-auto">
      <img
        className="mt-[-584px] mr-[-160px] mb-[184px] w-[575px] h-[314px] relative rounded-lg object-cover max-w-full shrink-0"
        alt=""
      ...
      <section className="self-stretch flex flex-row items-start justify-center pt-0 pb-[430.9px] pl-5 pr-[33px] box-border max-w-full mq450:pb-[182px] mq450:box-border mq1100:pb-[280px] mq1100:box-border">
        <div className="w-[967px] flex flex-row items-start justify-center gap-[61px] max-w-full gap-[15px] mq1100:flex-wrap gap-[30px]">
          <FrameComponent13 />
          <FrameComponent14 />
        </div>
      </section>
