...
const Interaction = () => {
  return (
    <div className="w-full h-[4191px] relative bg-gray-300 overflow-hidden flex flex-col items-start justify-start gap-8 leading-[normal] tracking-[normal] text-left text-31xl text-silver font-lato gap-4 mq1300:h-auto">
      ...
      <div className="w-[464px] flex flex-row items-start justify-center pt-0 px-5 pb-[145px] box-border max-w-full shrink-0">
        <button className="cursor-pointer border-border-brand-default border-[1px] border-solid py-4 px-[69px] bg-silver shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] rounded-radius-full overflow-hidden flex flex-row items-start justify-start gap-space-200 z-[1]">
          <img
            className="h-4 w-4 relative overflow-hidden shrink-0 hidden"
            alt=""
            src="/star4.svg"
          />
          <div className="relative text-5xl leading-[34px] font-extrabold font-lato text-gray-300 text-left inline-block min-w-[52px] mq450:text-lgi mq450:leading-[27px]">{`Chat `}</div>
          <img
            className="h-4 w-4 relative overflow-hidden shrink-0 hidden"
            alt=""
            src="/x6.svg"
      ...
      <section className="self-stretch flex flex-row items-start justify-center pt-0 pb-[74px] pl-[85px] pr-5 box-border max-w-full shrink-0 text-center text-31xl text-silver font-lato mq800:pl-[21px] mq800:box-border mq1100:pl-[42px] mq1100:box-border">
        <h1 className="m-0 w-[877px] relative text-inherit tracking-[-0.25px] leading-[64px] font-extrabold font-inherit flex items-center justify-center shrink-0 [text-shadow:0px_4px_4px_rgba(0,_0,_0,_0.25)] max-w-full mq800:text-21xl mq800:leading-[51px] mq450:text-11xl mq450:leading-[38px]">
      ...
      <section className="self-stretch flex flex-row items-start justify-center pt-0 pb-[104px] pl-[93px] pr-5 box-border max-w-full shrink-0 mq800:pl-[23px] mq800:pb-[68px] mq800:box-border mq1100:pl-[46px] mq1100:box-border">
        <div className="w-[977px] grid flex-row items-start justify-start gap-[33px] max-w-full grid-cols-[repeat(3,_minmax(228px,_1fr))] gap-4 mq800:grid-cols-[minmax(228px,_1fr)] mq1100:justify-center mq1100:grid-cols-[repeat(2,_minmax(228px,_395px))]">
          <FeaturesRow
      ...
      <section className="w-[1336px] flex flex-row items-start justify-center pt-0 px-5 pb-1.5 box-border max-w-full shrink-0 text-center text-31xl text-silver font-lato">
      ...
      <footer className="self-stretch bg-gray-300 flex flex-row items-end justify-center pt-[108px] pb-[154px] pl-[83px] pr-[18px] box-border [row-gap:20px] max-w-full shrink-0 text-left text-45xl text-silver font-lato mq800:pl-[41px] mq800:pt-[70px] mq800:pb-[100px] mq800:box-border mq1300:flex-wrap">
