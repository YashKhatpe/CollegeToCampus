...
const Interaction = () => {
  return (
    <>
      <Navbar1 />
      <div className="w-full h-[4191px] relative bg-gray-300 overflow-hidden flex flex-col items-start justify-start leading-[normal] tracking-[normal] text-left text-31xl text-silver font-poppins mq1300:h-auto">
        <img
          className="w-full h-[900px] blur-custom relative !m-[0] right-[0px] left-[0px] max-w-full overflow-hidden shrink-0 object-cover"
          alt=""
        ...
        <div className="w-[951px] flex flex-row items-start justify-center py-0 px-5 box-border max-w-full shrink-0 text-xl">
          <b className="w-[679px] bottom-[550px] relative inline-block shrink-0 max-w-full z-[1] mq450:text-base">
            <p className="m-0">{`Empowering your transition from college to a successful career with interactive tools and resources`}</p>
          </b>
        </div>

        <div className="bottom-[570px] pt-5 relative w-[464px] flex flex-row items-start justify-center px-5 pb-[145px] box-border max-w-full shrink-0">
          <Button1
            className="border-silver mt-[20px] text-silver ml-10 hover:border-primary"
            labeltext="Chat"
          />
        </div>
        ...
        <section className="self-stretch flex flex-row items-start justify-center pt-0 pb-[74px] pl-[85px] pr-5 box-border max-w-full shrink-0 text-center text-31xl text-silver font-poppins mq800:pl-[21px] mq800:box-border mq1100:pl-[42px] mq1100:box-border">
          <h1 className="mt-[180px] m-0 w-[877px] bottom-[420px] relative text-inherit tracking-[-0.25px] leading-[64px] font-extrabold font-inherit flex items-center justify-center shrink-0 [text-shadow:0px_4px_4px_rgba(0,_0,_0,_0.25)] max-w-full mq800:text-21xl mq800:leading-[51px] mq450:text-11xl mq450:leading-[38px]">
        ...
        <section className="self-stretch flex flex-row items-start justify-center pt-0 pb-[50px] pl-[93px] pr-5 box-border max-w-full shrink-0 mq800:pl-[23px] mq800:pb-[50px] mq800:box-border mq1100:pl-[46px] mq1100:box-border">
          <div className="bottom-[300px]  relative w-[977px] grid flex-row items-start font-poppins justify-start max-w-full grid-cols-[repeat(3,_minmax(228px,_1fr))] gap-4 mq800:grid-cols-[minmax(228px,_1fr)] gap-[33px] mq1100:justify-center mq1100:grid-cols-[repeat(2,_minmax(228px,_395px))]">
            <FeaturesRow
          ...
          <div className="w-[722px] flex flex-row items-end justify-between gap-5 max-w-full">
            <div className="relative w-[616px] flex flex-col items-start justify-end pt-0 px-0 pb-2 box-border max-w-[calc(100%_-_38px)]">
              <div className="self-stretch h-[91px] relative">
                <h1 className="left-[250px] m-0 relative top-[0px] left-[0px] text-inherit tracking-[-0.25px] leading-[64px] font-extrabold font-inherit flex items-center justify-center w-[616px] h-16 [text-shadow:0px_4px_4px_rgba(0,_0,_0,_0.25)] mq800:text-21xl mq800:leading-[51px] mq450:text-11xl mq450:leading-[38px]">
                  User Feedback
                </h1>
              </div>
            </div>
        ...
        <section className="self-stretch flex flex-row items-start justify-center pt-0 pb-[150px] pl-[93px] pr-5 box-border max-w-full shrink-0 mq800:pl-[23px] mq800:box-border mq1100:pl-[46px] mq1100:box-border mq450:pb-[100px] mq450:box-border">
